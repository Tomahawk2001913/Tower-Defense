...
import com.tomahawk2001913.landscrapetoo.towerdefense.map.towers.LaserCannonTower;
...
public class TowerPanel extends Panel {
	private enum Towers {
		...
		LASERCANNON(AssetHandler.laserCannonTower, new LaserCannonTower(new Vector2(0, 0), null));
